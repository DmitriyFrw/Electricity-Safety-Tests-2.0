...
def create_test(
    ...
    return TestService.create_test(db, user, form)
...
def get_test_for_edit(
    ...
    return TestService.get_test_for_edit(db, test_id, user)
...
def get_training_paper(
    ...
    return TestService.get_training_paper(db, test_id, user)
...
def submit_training(
    ...
    return TestService.submit_training(db, test_id, user, form)
...
def start_exam_session(
    ...
    return TestService.start_exam_session(db, test_id, user)
...
def get_exam_session(
    ...
    return TestService.get_exam_session(db, test_id, user)
...
def get_exam_ticket(
    ...
    return TestService.get_exam_ticket(db, test_id, ticket_id, user)
...
def submit_exam_ticket_answers(
    ...
    return TestService.submit_exam_ticket_answers(db, test_id, ticket_id, user, form)
...
def finish_exam(
    ...
    return TestService.finish_exam(db, test_id, user)
...
def sign_protocol(
    ...
    return TestService.sign_protocol(db, test_id, attempt_id, user)
...
def get_signed_protocol(
    ...
    return TestService.get_signed_protocol(db, test_id, attempt_id)
...
def get_signed_protocol_pdf(
    ...
    pdf_bytes = TestService.get_signed_protocol_pdf(db, test_id, attempt_id)
    return Response(
        content=pdf_bytes,
...
def add_ticket(
    ...
    return TestService.add_ticket(db, test_id, user)
...
def save_ticket(
    ...
    return TestService.save_ticket(db, test_id, ticket_id, user, form)
...
def delete_ticket(
    ...
    return TestService.delete_ticket(db, test_id, ticket_id, user)
