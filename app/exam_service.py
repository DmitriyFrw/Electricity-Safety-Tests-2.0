...
def ticket_deadline(started_at: dt.datetime) -> dt.datetime:
    return started_at + dt.timedelta(seconds=EXAM_TICKET_TIME_LIMIT_SECONDS)
...
def start_ticket_for_exam(
    ...
    *,
    ...
    """Открывает или возвращает активную попытку по билету. seconds_remaining — оставшееся время."""
    now = _utcnow()
